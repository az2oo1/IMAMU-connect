...
let content = fs.readFileSync('src/pages/GroupsTab.tsx', 'utf-8');
...
const mapEndStr = '              {displayedLoading && displayedHasMoreNewer && (';
...
fs.writeFileSync('src/pages/GroupsTab.tsx', content);
console.log("GroupsTab successfully modified!");
